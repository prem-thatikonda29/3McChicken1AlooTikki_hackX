      ...
      >
        ...
        <div className="prose prose-sm text-gray-600 mb-6">
          ...
          <div className="space-y-4">
            <p>
              In accordance with the Indian Medical Council (Professional
              Conduct, Etiquette and Ethics) Regulations and relevant data
              protection laws, we request your consent for the following:
            </p>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Collection and processing of your medical history and
                  health-related information
                </li>
                <li>
                  Analysis of your health data for risk assessment and
                  predictions
                </li>
                <li>
                  Secure storage of your medical information in accordance with
                  Indian healthcare regulations
                </li>
                <li>
                  Use of AI and machine learning algorithms for health analysis
                </li>
              </ul>
            </div>

            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-700 mb-2">Your Rights:</h4>
              <ul className="list-disc pl-5 space-y-2">
                <li>Access to your medical data at any time</li>
                <li>Right to request data modification or deletion</li>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>End-to-end encryption of your medical data</li>
                <li>
                  Compliance with Indian healthcare data protection standards
                </li>
            ...
            <p className="text-sm italic">
              This consent form complies with the guidelines set by the Medical
              Council of India and relevant Indian healthcare regulations.
            </p>
          </div>
        </div>
        ...
        <div className="border-t pt-6">
          <label className="flex items-center space-x-3 mb-6 cursor-pointer">
            ...
            <span className="text-gray-700">
              I have read and agree to the medical data processing terms and
              conditions
            </span>
          </label>
